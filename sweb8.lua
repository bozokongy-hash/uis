        ...
        function SectionElements:CreateToggle(name, callback)
            ...
            local function SetState(state)
                if state then
                    ...
                    TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundTransparency = 0, ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
