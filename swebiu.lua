...
local SwebwareUI = {
    Theme = {
        MainColor = Color3.fromRGB(147, 112, 219),
...
local function DarkenObjectColor(object, amount)
    local ColorR = math.max(0, (object.r * 255) - amount)
    local ColorG = math.max(0, (object.g * 255) - amount)
    local ColorB = math.max(0, (object.b * 255) - amount)
   
    return Color3.fromRGB(ColorR, ColorG, ColorB)
end

local function SetUIAccent(color)
    for i, v in pairs(SwebwareUI.LibraryColorTable) do
...
local function RippleEffect(object)
    spawn(function()
        ...
        TweenService:Create(Ripple, TweenInfo.new(1, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Position = UDim2.new(-5.5, 0, -5.5, 0), Size = UDim2.new(12, 0, 12, 0)}):Play()

        wait(0.5)
        TweenService:Create(Ripple, TweenInfo.new(1, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageTransparency = 1}):Play()
...
Main.BackgroundColor3 = SwebwareUI.Theme.BackgroundColor
Main.BackgroundTransparency = 1.000
Main.Position = UDim2.new(0.590086579, 0, 0.563882053, 0)
Main.Size = UDim2.new(0, 450, 0, 0)
Main.ZIndex = 2
Main.Image = "rbxassetid://3570695787"
Main.ImageColor3 = SwebwareUI.Theme.BackgroundColor
...
Border.Name = "Border"
Border.Parent = Main
Border.BackgroundColor3 = SwebwareUI.Theme.MainColor
Border.BackgroundTransparency = 1.000
Border.Position = UDim2.new(0, -1, 0, -1)
Border.Size = UDim2.new(1, 2, 1, 2)
Border.Image = "rbxassetid://3570695787"
Border.ImageColor3 = SwebwareUI.Theme.MainColor
...
TitleLabel.Size = UDim2.new(0, 430, 0, 25)
TitleLabel.ZIndex = 3
TitleLabel.Font = SwebwareUI.Theme.TextFont
TitleLabel.Text = "SwebWare QuickShot V1"
...
TweenService:Create(Main, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 450, 0, 250)}):Play()
TweenService:Create(Border, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageTransparency = 0}):Play()

table.insert(SwebwareUI.LibraryColorTable, Border)
table.insert(SwebwareUI.LibraryColorTable, TabButtons)
...
local function ResetAllTabButtons()
    for i, v in pairs(TabButtons:GetChildren()) do
        if v:IsA("ImageButton") then
            TweenService:Create(v, TweenInfo.new(0.3, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
        end
    end
end
...
local function KeepFirstTabOpen()
    for i, v in pairs(Tabs:GetChildren()) do
        if v:IsA("Frame") then
            if v.Name == (SwebwareUI.FirstTab .. "Tab") then
                v.Visible = true
            else
                v.Visible = false
            end
    ...
    for i, v in pairs(TabButtons:GetChildren()) do
        if v:IsA("ImageButton") then
            if v.Name:find(SwebwareUI.FirstTab .. "TabButton") then
                TweenService:Create(v, TweenInfo.new(0.3, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = DarkenObjectColor(SwebwareUI.Theme.MainColor, 15)}):Play()
            else
                TweenService:Create(v, TweenInfo.new(0.3, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
            end
        end
...
local function ToggleUI()
    SwebwareUI.UIOpen = not SwebwareUI.UIOpen
            
    if SwebwareUI.UIOpen then
        TweenService:Create(Main, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 450, 0, 0)}):Play()
        TweenService:Create(Border, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageTransparency = 1}):Play()
    elseif not SwebwareUI.UIOpen then
        TweenService:Create(Main, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 450, 0, 250)}):Play()
        TweenService:Create(Border, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageTransparency = 0}):Play()
    end
end

-- Add input handling for right shift key
UserInputService.InputBegan:Connect(function(input, gameprocessedevent)
    if not gameprocessedevent then
        if input.KeyCode == SwebwareUI.Theme.UIToggleKey then
            ToggleUI()
        end
    end
end)
...
coroutine.wrap(function()
    while wait() do
        SwebwareUI.RainbowColorValue = SwebwareUI.RainbowColorValue + 1/255
        SwebwareUI.HueSelectionPosition = SwebwareUI.HueSelectionPosition + 1

        if SwebwareUI.RainbowColorValue >= 1 then
            SwebwareUI.RainbowColorValue = 0
        end

        if SwebwareUI.HueSelectionPosition == 105 then
            SwebwareUI.HueSelectionPosition = 0
        end
    end
end)()


function SwebwareUI:CreateTab(name)
    ...
    local TabElements = {}
    SwebwareUI.TabCount = SwebwareUI.TabCount + 1

    if SwebwareUI.TabCount == 1 then
        SwebwareUI.FirstTab = name
    end
    ...
    NameTabButton.Size = UDim2.new(0, 105, 0, 25)
    NameTabButton.ZIndex = 2
    NameTabButton.Image = "rbxassetid://3570695787"
    NameTabButton.ImageColor3 = SwebwareUI.Theme.MainColor
    ...
    Title.ZIndex = 2
    Title.Font = SwebwareUI.Theme.TextFont
    Title.Text =  name
    ...
    table.insert(SwebwareUI.LibraryColorTable, NameTabButton)
    CloseAllTabs()
    ResetAllTabButtons()
    TweenService:Create(NameTabButton, TweenInfo.new(0.3, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = DarkenObjectColor(SwebwareUI.Theme.MainColor, 15)}):Play()
    ...
    function TabElements:CreateSection(name)
        ...
        NameSection.BackgroundColor3 = SwebwareUI.Theme.MainColor
        ...
        NameSection.ImageColor3 = SwebwareUI.Theme.BackgroundColor
        ...
        SectionBorder.BackgroundColor3 = SwebwareUI.Theme.MainColor
        ...
        SectionBorder.ImageColor3 = SwebwareUI.Theme.MainColor
        ...
        SectionTitle.BackgroundColor3 = SwebwareUI.Theme.BackgroundColor
        ...
        SectionTitle.Font = SwebwareUI.Theme.TextFont
        ...
        table.insert(SwebwareUI.LibraryColorTable, SectionBorder)
        ...
        function SectionElements:CreateLabel(name, text)
            ...
            NameLabel.ZIndex = 5
            NameLabel.Font = SwebwareUI.Theme.TextFont
            ...
            NameLabel:GetPropertyChangedSignal("TextBounds"):Connect(function()
                if NameLabel.Text ~= "" then
                    TweenService:Create(NameLabel, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 197, 0, NameLabel.TextBounds.Y)}):Play()
                else
                    TweenService:Create(NameLabel, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 197, 0, 0)}):Play()
                end
            end)
        ...
        function SectionElements:CreateButton(name, callback)
            ...
            ButtonRounded.ImageColor3 = SwebwareUI.Theme.MainColor
            ...
            Button.MouseButton1Down:Connect(function()
                TweenService:Create(ButtonRounded, TweenInfo.new(0.25, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = DarkenObjectColor(SwebwareUI.Theme.MainColor, 20)}):Play()
            ...
            Button.MouseButton1Up:Connect(function()
                TweenService:Create(ButtonRounded, TweenInfo.new(0.25, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
            end)
            ...
            table.insert(SwebwareUI.LibraryColorTable, ButtonRounded)
        end
        ...
        function SectionElements:CreateToggle(name, callback)
            ...
            Toggle.Font = SwebwareUI.Theme.TextFont
            Toggle.Text = ""
            ...
            CheckboxTicked.Image = "http://www.roblox.com/asset/?id=5416796047"
            CheckboxTicked.ImageColor3 = SwebwareUI.Theme.MainColor

            TickCover.Name = "TickCover"
            TickCover.Parent = Toggle
            TickCover.BackgroundColor3 = SwebwareUI.Theme.BackgroundColor
            ...
            local function SetState(state)
                if state then
                    ...
                    TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = SwebwareUI.Theme.MainColor}):Play()
                    TweenService:Create(CheckboxOutline, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
                    TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundTransparency = 1, ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
                elseif not state then
                    ...
                    TweenService:Create(TickCover, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundColor3 = SwebwareUI.Theme.BackgroundColor}):Play()
                    ...
                    TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {BackgroundTransparency = 1, ImageColor3 = Color3.fromRGB(65, 65, 65)}):Play()
				end
            ...
            table.insert(SwebwareUI.LibraryColorTable, CheckboxOutline)
            table.insert(SwebwareUI.LibraryColorTable, CheckboxTicked)
        ...
        function SectionElements:CreateSlider(name, minimumvalue, maximumvalue, presetvalue, precisevalue, callback)
            ...
            SliderIndicator.ImageColor3 = SwebwareUI.Theme.MainColor
            ...
            Value.ZIndex = 5
            Value.Font = SwebwareUI.Theme.TextFont
            ...
            local function Sliding(input)
                ...
                TweenService:Create(SliderIndicator, TweenInfo.new(0.02, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = SliderPosition}):Play()
            ...
            Value.FocusLost:Connect(function()
                ...
                TweenService:Create(SliderIndicator, TweenInfo.new(0.02, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(((tonumber(Value.Text) or minimumvalue) - minimumvalue) / (maximumvalue - minimumvalue), 0, 1, 0)}):Play()
            ...
            table.insert(SwebwareUI.LibraryColorTable, SliderIndicator)
        ...
        function SectionElements:CreateColorPicker(name, presetcolor, callback)
            ...
            ValueR.ZIndex = 11
            ValueR.Font = SwebwareUI.Theme.TextFont
            ValueR.Text = "R: 255"
            ...
            ValueG.ZIndex = 11
            ValueG.Font = SwebwareUI.Theme.TextFont
            ValueG.Text = "G: 255"
            ...
            ValueB.ZIndex = 11
            ValueB.Font = SwebwareUI.Theme.TextFont
            ValueB.Text = "B: 255"
            ...
            RainbowToggleTitle.Font = SwebwareUI.Theme.TextFont
            ...
            Toggle.MouseButton1Down:Connect(function()
                ...
                if RainbowColorPicker then              
                    ...
                    TweenService:Create(CheckboxOutline, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
                    TweenService:Create(CheckboxTicked, TweenInfo.new(0.12, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {ImageColor3 = SwebwareUI.Theme.MainColor}):Play()
                    ...
                    while RainbowColorPicker do
                        ColorPickerToggle.ImageColor3 = Color3.fromHSV(SwebwareUI.RainbowColorValue, 1, 1)
                        Color.BackgroundColor3 = Color3.fromHSV(SwebwareUI.RainbowColorValue, 1, 1)
            
                        ColorSelection.Position = UDim2.new(1, 0, 0, 0)
                        HueSelection.Position = UDim2.new(0.48, 0, 0, SwebwareUI.HueSelectionPosition)
            ...
            ColorPickerToggle.MouseButton1Down:Connect(function()
                ...
                if ColorPickerToggled then
                    TweenService:Create(NameColorPicker, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 197, 0, 210)}):Play()
                    TweenService:Create(ColorPicker, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageTransparency = 0}):Play()
                elseif not ColorPickerToggled then
                    TweenService:Create(NameColorPicker, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 197, 0, 32)}):Play()
                    TweenService:Create(ColorPicker, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {ImageTransparency = 1}):Play()
                end
            end)
        ...
        function SectionElements:CreateDropdown(name, options, presetoption, callback)
            ...
            TitleToggle.Font = SwebwareUI.Theme.TextFont
            ...
            Dropdown.BackgroundColor3 = SwebwareUI.Theme.BackgroundColor
            ...
            local function ResetAllDropdownItems()
                for i, v in pairs(Dropdown:GetChildren()) do
                    if v:IsA("TextButton") then
                        TweenService:Create(v, TweenInfo.new(0.25, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                    end
                end
            end
            ...
            local function ClearAllDropdownItems()
                ...
                TweenService:Create(TitleToggle, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                TweenService:Create(NameDropdown, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 197, 0, 35)}):Play()
                TweenService:Create(Dropdown, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 165, 0, 0)}):Play()
            end
            ...
            for i, v in pairs(options) do
                ...
                NameButton.Font = SwebwareUI.Theme.TextFont
                NameButton.Text = v
                NameButton.TextColor3 = Color3.fromRGB(255, 255, 255)
                NameButton.TextSize = 15.000

                table.insert(SwebwareUI.LibraryColorTable, NameButton)

                if v == SelectedOption then
                    NameButton.TextColor3 = SwebwareUI.Theme.MainColor
                end
                ...
                NameButton.MouseButton1Down:Connect(function()
                    ...
                    TitleToggle.Text = (name .. " - " .. SelectedOption)
                    TweenService:Create(NameButton, TweenInfo.new(0.35, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = SwebwareUI.Theme.MainColor}):Play()
                    callback(NameButton.Text)
                end)

                NameButton.InputBegan:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseMovement then
                        TweenService:Create(NameButton, TweenInfo.new(0.35, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {BackgroundTransparency = 0.95}):Play()
                    end
                end)

                NameButton.InputEnded:Connect(function(input)
                    if input.UserInputType == Enum.UserInputType.MouseMovement then
                        TweenService:Create(NameButton, TweenInfo.new(0.35, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {BackgroundTransparency = 1}):Play()
                    end
                end)
            end
            ...
            TitleToggle.MouseButton1Down:Connect(function()
                ...
                elseif not DropdownToggled then
                    TweenService:Create(TitleToggle, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(185, 185, 185)}):Play()
                    TweenService:Create(NameDropdown, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 197, 0, 35 + DropdownContentLayout.AbsoluteContentSize.Y)}):Play()
                    TweenService:Create(Dropdown, TweenInfo.new(0.5, SwebwareUI.Theme.EasingStyle, Enum.EasingDirection.Out), {Size = UDim2.new(0, 165, 0, DropdownContentLayout.AbsoluteContentSize.Y)}):Play()
                end
            end)
        ...
        function SectionElements:CreateKeybind(name, presetbind, keyboardonly, holdmode, callback)
            ...
            KeybindButton.Font = SwebwareUI.Theme.TextFont
