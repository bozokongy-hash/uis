...
UISwebwareUI.Name = HttpService:GenerateGUID(false)
UISwebwareUI.Parent = CoreGui
UISwebwareUI.DisplayOrder = 1
UISwebwareUI.ZIndexBehavior = Enum.ZIndexBehavior.Global
